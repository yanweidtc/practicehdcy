...
public class ExpandableTextView extends LinearLayout implements
    ...
    private TextView expand_collapse_tv;
    private View expand_collapse_layout;
    ...
    public void onClick(View view) {
        ...
        mButton.setImageDrawable(mCollapsed ? mExpandDrawable
                : mCollapseDrawable);
        expand_collapse_tv.setText(mCollapsed ? mExpandText : mCollapseText);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        expand_collapse_layout.setVisibility(View.GONE);
        ...
        expand_collapse_layout.setVisibility(View.VISIBLE);
    ...
    public void setOnExpandStateChangeListener(
            @Nullable OnExpandStateChangeListener listener) {
        mListener = listener;
    }
    ...
    public void setText(@Nullable CharSequence text,
                        @NonNull SparseBooleanArray collapsedStatus, int position) {
    ...
    private void findViews() {
        ...
        expand_collapse_tv = (TextView) findViewById(R.id.expand_collapse_tv);
        expand_collapse_tv.setText(mCollapsed ? mExpandText : mCollapseText);
        expand_collapse_tv.setOnClickListener(this);
        expand_collapse_layout = findViewById(R.id.expand_collapse_layout);
        expand_collapse_layout.setOnClickListener(this);
    }
